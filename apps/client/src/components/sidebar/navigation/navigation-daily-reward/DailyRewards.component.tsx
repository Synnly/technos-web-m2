...
const DailyRewards: React.FC<{ onClick?: () => void }> = ({ onClick }) => {
  return (
    <div className="mb-6 relative">
      ...
      <div className="absolute -top-2 -right-2 w-6 h-6 text-yellow-400 sparkle">
        <Gift className="w-4 h-4" />
      </div>
      <div className="absolute -top-1 -left-1 w-4 h-4 text-yellow-300 sparkle" style={{ animationDelay: '0.5s' }}>
      ...
      >
        <div className="absolute top-2 right-2 mascot-float">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="text-left">
            <span className="font-bold text-lg gradient-text block">Daily Rewards</span>
        ...
        <div className="mt-2 flex items-center justify-between">
          ...
          <div className="flex space-x-1">
            ...
            <div className="w-2 h-2 bg-yellow-400 rounded-full sparkle" style={{ animationDelay: '0.3s' }}></div>
            <div className="w-2 h-2 bg-yellow-400 rounded-full sparkle" style={{ animationDelay: '0.6s' }}></div>
          </div>
        </div>
      </button>
    </div>
